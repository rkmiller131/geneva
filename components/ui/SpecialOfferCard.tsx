...
export default function SpecialOfferCard({ card }: SpecialOfferCardProps) {
  ...
  return (
    <div
      id={`card${card.id}`}
      className="w-[30%] h-[350px] border border-[0.3px] border-gray-300 bg-[rgba(0,83,185,0.5)] rounded-md p-3"
    >
